...
export const EXERCISES = {
  ...
  landmine_press: {
    ...
    variants: {
      unilateral:
        'Stand with the end of a t-bar in one hand with your thumb near to your shoulder and your body at a 45 degree to the plane of the bar. Press the bar up and across your chest until your arm is extended and lower back down.',
      two_handed:
